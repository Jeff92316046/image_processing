...
# the imagea
# image = cv2.imread("assets/tetris_blocks.png")
...
for i, c in enumerate(cnts):
    ...
    # compute the aspect ratio of the contour, which issimply the width
    ...
    # if the width is 3x longer than the height, then we have a rectangle
        ...
        shape = "RECTANGLE"
    # if the extent is sufficiently small, then we have a Lpiece
    elif extent < 0.65:
        shape = "L-PIECE"
    ...
    print(
        "Contour #{} -- aspect_ratio={:.2f},extent={:.2f}, solidity={:.2f}".format(
